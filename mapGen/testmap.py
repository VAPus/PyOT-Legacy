...
map = Map(640,640, ground=RSItem(4608, 4609)) # Make a 640x640 map filled with water
...
area.border(0, Item(4632), Item(4634), Item(4633), Item(4635), northeast=Item(4638), northwest=Item(4639), southeast=Item(4640), southwest=Item(4641) )
