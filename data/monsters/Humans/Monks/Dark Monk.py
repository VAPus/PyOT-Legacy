Dark_Monk = genMonster("Dark Monk", (225, 6080), "a Dark Monk")
...
Dark_Monk.behavior(summonable=0, hostile=1, illusionable=1, convinceable=480, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
