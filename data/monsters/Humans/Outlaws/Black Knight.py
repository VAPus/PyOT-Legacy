Black_Knight = genMonster("Black Knight", (131, 6080), "a Black Knight")
...
Black_Knight.loot( ("spear", 60.5, 3), ("steel helmet", 12.25), (3031, 100, 128), ("two handed sword", 10.0), ("warrior helmet", 4.75), ("halberd", 12.25), ("dark helmet", 3.0), ("battle hammer", 6.5), ("knight axe", 3.0), ("lightning legs", 0.75), ("dark armor", 1.75), ("brown bread", 28.75, 2), ("brass legs", 13.75), ("rope", 14.25), ("plate armor", 11.25), ("dragon lance", 1.0), ("knight legs", 1.75), ("knight armor", 0.5), ("ruby necklace", 1.0), ("boots of haste", 0.25) )