Smuggler = genMonster("Smuggler", (134, 6080), "a Smuggler")
...
Smuggler.loot( (3031, 100, 10), ("leather legs", 14.5), ("torch", 45.0, 2), ("ham", 10.0), ("combat knife", 4.0), ("knife", 10.0), ("leather helmet", 10.25), ("short sword", 10.25), ("raspberry", 16.75, 5), ("sword", 4.5), ("deer trophy", 0.25) )