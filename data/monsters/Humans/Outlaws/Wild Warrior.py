...
Wild_Warrior.loot( ("brass shield", 18.0), (3031, 100, 30), ("mace", 10.25), ("leather legs", 7.75), ("chain helmet", 5.0), ("steel shield", 1.0), ("axe", 29.5), ("egg", 15.5, 2), ("iron helmet", 0.75), ("brass armor", 2.5), ("doll", 0.5) )