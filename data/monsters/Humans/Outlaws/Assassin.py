Assassin = genMonster("Assassin", (152, 6080), "a Assassin")
...
Assassin.regDistance(40, ANIMATION_THROWINGSTAR, chance(21))
Assassin.loot( ("throwing star", 50.5, 14), (3031, 100, 50), ("knife", 10.25), ("torch", 42.25, 2), ("viper star", 18.0, 7), ("combat knife", 4.0), ("steel shield", 1.25), ("steel helmet", 2.75), ("plate shield", 2.0), ("battle shield", 1.5), ("leopard armor", 0.5), ("horseman helmet", 0.25), ("small diamond", 0.0025) )