Crazed_Beggar = genMonster("Crazed Beggar", (153, 6080), "a Crazed Beggar")
...
Crazed_Beggar.loot( ("wooden spoon", 9.25), (3031, 100, 9), ("dirty cape", 62.25), ("roll", 19.0), ("meat", 9.0, 2), ("wooden hammer", 9.75), ("rolling pin", 5.0), ("red rose", 4.75), (1681, 0.25), ("rum flask", 0.5), ("lute", 0.25), ("rusty armor", 0.5), ("sling herb", 0.25), ("very noble-looking watch", 0.25), ("dwarven ring", 0.0025) )