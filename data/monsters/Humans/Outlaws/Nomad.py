Nomad = genMonster("Nomad", (146, 6080), "a Nomad")
...
Nomad.regMelee(80)
Nomad.loot( (3031, 100, 39), ("axe", 18.75), ("leather legs", 8.75), ("brass shield", 10.25), ("mace", 7.5), ("brass armor", 2.25), ("chain helmet", 2.75), ("steel shield", 0.75), (8838, 8.25, 3), ("iron helmet", 0.75), ("parchment", 0.25), ("rope belt", 2.75), (12412, 1.0) )