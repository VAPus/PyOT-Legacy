...
Valkyrie.loot( ("girlish hair decoration", 5.5), ("red apple", 11.5, 2), ("hunting spear", 4.75), ("meat", 29.75, 3), (3031, 100, 12), ("spear", 100, 3), ("chain armor", 8.0), ("protective charm", 2.75), ("plate armor", 1.25), ("skull", 0.5), ("protection amulet", 0.75), ("double axe", 0.25), ("health potion", 0.25) )