...
pirate_corsair.behavior(summonable=0, hostile=2, illusionable=1, convinceable=775, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0, targetChange=0)
