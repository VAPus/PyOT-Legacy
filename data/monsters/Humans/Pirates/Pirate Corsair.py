...
pirate_corsair.loot( ("throwing star", 53.75, 12), ("rum flask", 0.0025), (3031, 100, 88), ("sabre", 9.75), ("compass", 10.0), ("dark shield", 1.25), ("peg leg", 0.5), ("pirate boots", 0.25), ("hook", 0.5, 3), ("dark armor", 1.75), ("pirate backpack", 1.0), ("strong health potion", 0.75), ("eye patch", 0.5), ("pirate hat", 0.75), ("skull candle", 0.25), ("piggy bank", 0.25) )