...
pirate_marauder.loot( (3031, 100, 40), ("pirate bag", 0.5), ("torch", 10.0), ("chain armor", 3.0), ("compass", 10.25), ("hook", 0.5, 3), ("spear", 7.25, 2), ("treasure map", 1.0), ("peg leg", 0.5), ("plate shield", 5.0), ("bandana", 1.0), ("rum flask", 0.0025), ("eye patch", 0.5), ("goldfish bowl", 0.25), ("dice", 0.0025) )