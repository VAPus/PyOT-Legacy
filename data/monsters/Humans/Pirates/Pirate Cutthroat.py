...
pirate_cutthroat.behavior(summonable=0, hostile=2, illusionable=1, convinceable=495, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=20, targetChange=0)
