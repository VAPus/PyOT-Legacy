Barbarian_Headsplitter = genMonster("Barbarian Headsplitter", (253, 6080), "a Barbarian Headsplitter")
...
Barbarian_Headsplitter.loot( (3031, 100, 30), ("torch", 60.5), ("brass helmet", 20.25), ("scale armor", 4.25), ("viking helmet", 4.5), ("knife", 15.0), ("health potion", 0.5), ("life ring", 0.25), ("skull", 3.25), ("krimhorn helmet", 0.0025), ("brown piece of cloth", 1.0, 3), ("fur boots", 0.0025) )