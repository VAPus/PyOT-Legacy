...
Barbarian_Bloodwalker.loot( (3031, 100, 12), ("chain helmet", 10.75), ("chain armor", 9.75), ("battle axe", 6.25), ("ham", 7.5), ("lamp", 8.5), ("halberd", 7.0), ("shard", 0.25), ("red piece of cloth", 0.75, 3), ("health potion", 1.25), ("beastslayer axe", 0.25), ("fur boots", 0.25) )