...
Barbarian_Bloodwalker.behavior(summonable=0, hostile=1, illusionable=0, convinceable=590, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
