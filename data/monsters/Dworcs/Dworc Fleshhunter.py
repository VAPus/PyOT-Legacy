...
dworc_fleshhunter.loot( (2148, 100, 13), ("cleaver", 8.5), ("skull", 5.75, 3), ("hunting spear", 2.0), ("torch", 5.25), ("leather armor", 11.0), ("poison dagger", 2.0), ("tribal mask", 0.5), ("bone shield", 1.25), ("ripper lance", 0.0025) )