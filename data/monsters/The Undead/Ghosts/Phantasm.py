...
phantasm.loot( (3031, 100, 268), ("blank rune", 36.25, 2), ("shadow herb", 29.25), ("demonic essence", 19.5, 3), ("small emerald", 15.0, 3), ("rusty armor", 7.75), ("soul orb", 11.25), ("great mana potion", 5.0), ("platinum coin", 1.25), ("crown armor", 0.5), ("stealth ring", 0.75), ("abyss hammer", 0.25) )