...
undead_gladiator.bloodType("undead")
...
undead_gladiator.loot( ("plate armor", 2.5), (3031, 100, 148), ("brass legs", 6.75), ("brass armor", 6.0), ("scimitar", 11.25), ("protection amulet", 2.25), ("hunting spear", 4.5), ("belted cape", 4.5), ("throwing star", 100, 18), ("two handed sword", 2.5), ("meat", 4.75, 2), ("plate legs", 2.0), ("dark helmet", 1.25), ("health potion", 0.75), (5885, 0.25), ("knight axe", 0.5), ("broken gladiator shield", 3.5), ("stealth ring", 0.25), ("crusader helmet", 0.0025) )