...
bonebeast.loot( ("plate armor", 8.0), ("skull", 20.25), (3031, 100, 90), ("bone", 49.25), ("bony tail", 10.0), ("bone shield", 2.0), ("bone club", 5.0), ("green mushroom", 1.5), ("hardened bone", 1.0, 3), ("health potion", 0.5) )