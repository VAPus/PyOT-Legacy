...
blightwalker.loot( ("bunch of wheat", 59.75), (3031, 100, 271), ("soul orb", 25.5), ("bundle of cursed straw", 10.0), ("rusty armor", 7.75), ("demonic essence", 30.25), ("poison arrow", 46.25, 12), ("blank rune", 38.5, 2), ("terra mantle", 0.5), ("great health potion", 9.5), ("scythe", 3.25), ("hailstorm rod", 7.75), ("seeds", 2.0), ("terra legs", 1.5), ("garlic necklace", 1.0), ("skull staff", 0.75), ("gold ring", 1.0), ("death ring", 0.25), ("amulet of loss", 0.25), ("gold ingot", 0.0025), ("golden sickle", 0.0025) )