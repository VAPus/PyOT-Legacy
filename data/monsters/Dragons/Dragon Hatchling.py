...
dragon_hatchling.setDefense(armor=1, fire=0, earth=0.25, energy=1.05, ice=1.1, holy=1, death=1, physical=1, drown=1)
...
dragon_hatchling.loot( (2148, 100, 55), ("dragon ham", 53.75), (12413, 3.5), ("health potion", 0.25) )