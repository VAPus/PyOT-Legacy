...
frost_giant.setDefense(armor=20, fire=1, earth=1, energy=1, ice=0, holy=1, death=1, physical=1, drown=1)
...
frost_giant.voices("Hmm Humansoup!", "Stand still ya tasy snack!", "Joh Thun!", "Hörre Sjan Flan!", "Bröre Smöde!", "Forle Bramma")
