frost_giant = genMonster("Frost Giant", (257, 7330), "a frost giant")
frost_giant.setHealth(270)
frost_giant.bloodType("blood")
...
frost_giant.loot( (3031, 100, 40), ("short sword", 8.75), ("meat", 4.75, 2), ("shard", 0.0025), ("frost giant pelt", 5.25), ("ice cube", 2.0), ("dark helmet", 0.25), ("health potion", 0.75), ("battle shield", 1.75), ("halberd", 0.75), ("club ring", 0.0025), ("norse shield", 0.25) )