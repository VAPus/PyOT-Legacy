...
frost_giantess.behavior(summonable=490, hostile=1, illusionable=1, convinceable=490, pushable=0, pushItems=1, pushCreatures=1, targetDistance=4, runOnHealth=0)
