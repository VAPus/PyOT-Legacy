...
dwarf_geomancer.bloodType("blood")
...
dwarf_geomancer.loot( (3031, 100, 45), ("white mushroom", 89.5, 2), ("pear", 25.25), ("blank rune", 34.5), (12414, 7.75), ("dwarven ring", 0.75), (2162, 13.25), (12419, 6.75), ("small sapphire", 0.25), ("spellbook", 0.0025), ("iron ore", 0.5), ("clerical mace", 1.0), ("terra boots", 0.0025) )