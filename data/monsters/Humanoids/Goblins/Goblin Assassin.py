goblin_assassin = genMonster("Goblin Assassin", (296, 6002), "a goblin assassin")
goblin_assassin.setHealth(75, healthmax=75)
goblin_assassin.bloodType("blood")
...
goblin_assassin.regDistance(35, ANIMATION_THROWINGKNIFE, chance(21))
goblin_assassin.loot( ("bone club", 5.0), ("leather armor", 8.0), ("small axe", 11.75), (2235, 6.75), ("leather helmet", 11.25), (3031, 100, 9), ("dagger", 19.0), ("small stone", 21.0, 3), ("fish", 14.25), ("bone", 10.75), ("short sword", 8.75) )