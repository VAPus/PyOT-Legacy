...
goblin_scavenger.behavior(summonable=0, hostile=1, illusionable=1, convinceable=310, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=12)
