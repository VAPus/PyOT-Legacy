...
troll.regMelee(15)
troll.loot( ("spear", 13.5), ("rope", 8.75), (3031, 100, 12), ("meat", 15.25), ("wooden shield", 10.5), ("hand axe", 17.25), ("leather helmet", 12.0), ("leather boots", 10.0), ("studded club", 4.75), ("bunch of troll hair", 0.75), ("silver amulet", 0.0025) )