...
orc_warrior.loot( (3031, 100, 15), ("meat", 15.75), ("chain armor", 7.25), ("skull belt", 1.25), ("orc tooth", 0.75), ("orc leather", 4.0), ("broken helmet", 10.25), ("copper shield", 0.5), ("poison dagger", 0.0025) )