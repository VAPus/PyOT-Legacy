...
orc_rider.loot( ("orcish axe", 6.75), ("warwolf fur", 10.75), ("meat", 27.0, 3), (3031, 100, 74), ("orc leather", 8.75), ("scale armor", 1.0), ("torch", 1.75), ("wolf tooth chain", 9.25), ("orc tooth", 2.5), ("battle shield", 0.75), ("obsidian lance", 0.75) )