...
orc_berserker = genMonster("Orc Berserker", (8, 5980), "an orc berserker")
orc_berserker.setHealth(210)
orc_berserker.bloodType("blood")
...
orc_berserker.loot( ("orc leather", 4.0), ("hunting spear", 4.25), ("halberd", 6.5), ("orcish gear", 9.0), (3031, 100, 12), ("battle axe", 6.0), ("ham", 10.5), ("lamp", 0.75), ("orc tooth", 2.75), ("chain armor", 1.25) )