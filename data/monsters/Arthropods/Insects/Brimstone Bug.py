brimstone_bug = genMonster("Brimstone Bug", (352, 12527), "a brimstone bug")
...
brimstone_bug.loot( ("stealth ring", 1.0), ("strong health potion", 9.0), ("sulphurous stone", 14.75), (12658, 6.25), ("strong mana potion", 8.75), ("brimstone shell", 9.75), ("magic sulphur", 1.75), ("lump of earth", 19.75), ("small emerald", 6.0, 4), ("poisonous slime", 50.75), (3031, 100, 197), ("platinum amulet", 0.25) )
