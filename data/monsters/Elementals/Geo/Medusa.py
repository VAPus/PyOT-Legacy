...
medusa.speed(240)
medusa.behavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=500)
...
medusa.regMelee(450, condition=CountdownCondition(CONDITION_POISON, 42), conditionChance=100)
