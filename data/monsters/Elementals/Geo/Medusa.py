...
medusa.loot( ("small emerald", 10.0, 4), ("terra amulet", 3.75), ("ultimate health potion", 14.75, 2), ("medusa shield", 3.0), ("great mana potion", 15.25, 2), ("strand of medusa hair", 10.0), ("platinum coin", 100, 6), (3031, 100, 190), ("terra legs", 0.5), ("titan axe", 1.25), ("terra mantle", 0.75), ("sacred tree amulet", 1.0), ("knight armor", 2.0), ("rusty armor", 0.25) )