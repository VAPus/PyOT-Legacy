...
gargoyle.loot( ("stone wing", 10.0), ("morning star", 1.0), ("battle shield", 1.5), (3031, 100, 30), (8838, 7.5, 2), ("small stone", 83.0, 10), ("dark armor", 0.25), ("club ring", 0.25), ("strawberry", 3.25, 5), ("shiny stone", 0.25), ("piece of marble rock", 0.5), ("wolf tooth chain", 0.25), ("steel helmet", 0.25) )