...
energy_elemental.loot( (3031, 100, 169), ("crystal sword", 6.25), ("mana potion", 11.75), ("flash arrow", 61.75, 10), ("strong mana potion", 8.75), ("throwing star", 30.25, 5), ("obsidian lance", 4.0), ("small amethyst", 7.75, 2), ("guardian shield", 0.5), ("energy ring", 0.5), ("crystal ring", 1.75), ("silver amulet", 1.0), ("wand of cosmic energy", 0.75) )