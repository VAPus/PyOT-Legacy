fire_elemental = genMonster("Fire Elemental", (49, 8964), "a fire elemental")
...
fire_elemental.behavior(summonable=690, hostile=1, illusionable=1, convinceable=690, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
