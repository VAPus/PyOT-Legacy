...
serpent_spawn.loot( (3031, 100, 245), ("life ring", 6.0), ("energy ring", 6.0), ("small sapphire", 12.0), ("green mushroom", 17.75), ("power bolt", 5.75), ("great mana potion", 2.0), ("snake skin", 14.75), ("crown armor", 0.5), ("warrior helmet", 0.5), ("life crystal", 0.75), ("mercenary sword", 2.0), ("golden mug", 3.0), ("strange helmet", 0.75), ("snakebite rod", 1.0), ("old parchment", 0.5), ("winged tail", 1.0), ("noble axe", 0.75), ("royal helmet", 0.0025), ("spellbook of mind control", 0.0025), (3971, 0.25), ("tower shield", 0.75), ("swamplair armor", 0.0025) )
