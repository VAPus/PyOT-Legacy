...
young_sea_serpent.bloodType("blood")
...
young_sea_serpent.loot( ("battle hammer", 5.25), ("strong health potion", 5.0), ("strong mana potion", 4.0), ("sea serpent scale", 5.0), ("morning star", 39.75), ("battle axe", 8.0), ("rusty armor", 8.0, 2), (3031, 100, 174), ("stealth ring", 1.0), ("life crystal", 0.25), ("small sapphire", 3.0, 2) )