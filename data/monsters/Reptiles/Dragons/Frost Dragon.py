...
frost_dragon.loot( (3031, 100, 245), ("dragon ham", 77.5, 5), ("power bolt", 21.0, 6), ("golden mug", 3.0), ("energy ring", 5.0), ("small sapphire", 5.0), ("green mushroom", 12.0), ("ice cube", 4.0), ("book", 9.0), ("life crystal", 0.5), ("dragon scale mail", 0.0025), ("shard", 0.5), ("tower shield", 0.25), ("ice rapier", 0.25), ("strange helmet", 0.5), ("dragon slayer", 0.0025), ("royal helmet", 0.25) )
