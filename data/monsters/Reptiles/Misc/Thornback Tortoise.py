Thornback_Tortoise = genMonster("Thornback Tortoise", (198, 6073), "a thornback tortoise")
...
Thornback_Tortoise.behavior(summonable=0, hostile=1, illusionable=1, convinceable=490, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
