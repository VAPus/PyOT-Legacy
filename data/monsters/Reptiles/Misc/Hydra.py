...
hydra.loot( (3031, 100, 244), ("ham", 60.25, 4), ("small sapphire", 5.0), ("hydra head", 10.0), ("cucumber", 5.0), ("knight armor", 1.0), ("ring of healing", 1.25), ("medusa shield", 0.25), ("warrior helmet", 1.0), ("life crystal", 0.75), ("hydra egg", 1.0), ("stone skin amulet", 0.75), ("strong mana potion", 0.5), ("royal helmet", 0.25), ("boots of haste", 0.0025) )
