draken_abomination = genMonster("Draken Abomination", (357, 12623), "a draken abomination")
draken_abomination.setHealth(6250, healthmax=6250)
draken_abomination.bloodType("blood")
...
draken_abomination.loot( ("small topaz", 7.0, 4), ("ultimate health potion", 22.25, 3), ("meat", 48.75, 4), ("platinum coin", 100, 8), (3031, 100, 195), ("scale of corruption", 9.0), ("eye of corruption", 13.25), ("tail of corruption", 5.5), ("terra hood", 8.5), ("great spirit potion", 10.25, 3), ("zaoan legs", 1.25), ("great mana potion", 17.5, 3), ("draken boots", 1.0), ("zaoan helmet", 0.5), ("wand of voodoo", 1.5), ("zaoan armor", 1.0) )