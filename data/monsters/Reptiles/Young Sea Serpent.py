...
young_sea_serpent.setDefense(armor=19, fire=0.7, earth=0, energy=1.1, ice=0, holy=1, death=1.15, physical=1.2, drown=0)
...
young_sea_serpent.loot( ("battle hammer", 5.25), ("strong health potion", 5.0), ("strong mana potion", 4.0), ("sea serpent scale", 5.0), ("morning star", 39.5), ("battle axe", 7.75), ("rusty armor", 8.0, 2), (2148, 100, 174), ("stealth ring", 1.0), ("life crystal", 0.25), ("small sapphire", 3.25, 2) )