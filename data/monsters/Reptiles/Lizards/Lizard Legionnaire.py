...
lizard_legionnaire.loot( ("legionnaire flags", 2.0), ("lizard scale", 1.0, 3), ("zaoan halberd", 1.0), ("strong health potion", 4.0), ("broken halberd", 14.75), (3031, 100, 165), ("lizard leather", 1.0), ("drakinata", 0.75), ("red lantern", 0.5), ("bunch of ripe rice", 2.0), ("small diamond", 1.5, 2), ("zaoan shoes", 0.5), ("zaoan armor", 0.0025), ("lizard trophy", 0.0025) )