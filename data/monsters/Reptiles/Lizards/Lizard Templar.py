lizard_templar = genMonster("Lizard Templar", (113, 4251), "a lizard templar")
lizard_templar.setHealth(410, healthmax=410)
lizard_templar.bloodType("blood")
...
lizard_templar.loot( (3031, 100, 60), ("lizard leather", 0.75), ("sword", 5.25), ("steel helmet", 2.0), ("short sword", 10.0), ("templar scytheblade", 0.5), ("health potion", 1.0), ("morning star", 2.5), ("lizard scale", 1.0, 3), ("plate armor", 1.0), ("small emerald", 0.25) )