...
vampire.loot( ("vampire teeth", 4.75), (2148, 100, 20), ("strange helmet", 0.5), ("grave flower", 1.75), ("katana", 1.5), ("spike sword", 1.0), ("ice rapier", 0.25), ("skull", 1.0), ("black pearl", 1.5), ("blood preservation", 1.0), ("emerald bangle", 0.25), ("strong health potion", 0.75), ("bronze amulet", 0.25), ("vampire shield", 0.25) )