...
mummy.regMelee(85)
mummy.loot( (2148, 100, 80), ("flask of embalming fluid", 11.5), (2162, 6.0), (3976, 35.5, 3), ("gauze bandage", 10.25), ("silver brooch", 3.75), ("strange talisman", 5.25), ("yellow piece of cloth", 1.0, 3), ("poison dagger", 0.5), ("crystal ring", 2.0), ("black shield", 0.25), ("black pearl", 1.0), ("silver amulet", 0.25) )