...
skeleton_warrior.setDefense(10, armor=2, fire=1, earth=1, energy=1, ice=1, holy=1.25, death=0, physical=1, drown=1)
skeleton_warrior.setExperience(45)
skeleton_warrior.setSpeed(180)
skeleton_warrior.setBehavior(summonable=350, attackable=1, hostile=1, illusionable=1, convinceable=1, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
