...
undead_prospector.setDefense(17, armor=8, fire=1, earth=0.8, energy=0.7, ice=0.9, holy=1.25, death=0, physical=1, drown=0)
undead_prospector.setExperience(85)
undead_prospector.setSpeed(180)
undead_prospector.setBehavior(summonable=440, attackable=1, hostile=1, illusionable=1, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
undead_prospector.walkAround(energy=0, fire=1, poison=0)
