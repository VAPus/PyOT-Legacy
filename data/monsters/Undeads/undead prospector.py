...
undead_prospector.setBehavior(summonable=440, hostile=1, illusionable=1, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)#convinceable?
