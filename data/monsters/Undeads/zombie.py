...
zombie.setDefense(10, armor=15, fire=0.5, earth=0, energy=0, ice=0, holy=1, death=0, physical=1, drown=0)
zombie.setExperience(280)
zombie.setSpeed(180)#incorrect speed?
zombie.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
