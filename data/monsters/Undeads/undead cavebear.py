...
undead_cavebear.setDefense(10, armor=5, fire=1, earth=0, energy=1, ice=1, holy=1.01, death=0, physical=1, drown=1)
undead_cavebear.setExperience(600)
undead_cavebear.setSpeed(speed)#unknown speed
undead_cavebear.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
