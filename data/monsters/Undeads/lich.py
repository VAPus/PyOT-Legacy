...
lich.setDefense(20, armor=20, fire=1, earth=0, energy=0.2, ice=1, holy=1.2, death=0, physical=1, drown=1)
lich.setExperience(900)
lich.setSpeed(320)
lich.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
