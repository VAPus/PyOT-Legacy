...
lost_soul.setDefense(35, armor=25, fire=0, earth=0, energy=0.9, ice=0.5, holy=1.25, death=0, physical=1, drown=1)
lost_soul.setExperience(4000)
lost_soul.setSpeed(speed)
lost_soul.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=1, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
