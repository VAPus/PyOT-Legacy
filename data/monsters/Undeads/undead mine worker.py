...
undead_mine_worker.setDefense(9, armor=2, fire=1, earth=1, energy=1, ice=1, holy=1.01, death=0, physical=1, drown=1)
undead_mine_worker.setExperience(45)
undead_mine_worker.setSpeed(154)
undead_mine_worker.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=1, convinceable=1, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
