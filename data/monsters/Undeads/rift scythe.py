...
rift_scythe = game.monster.genMonster("Rift Scythe", (300), "a rift scythe")#no corpse
rift_scythe.setHealth(3600)
rift_scythe.bloodType(color="undead")
rift_scythe.setDefense(30, armor=30, fire=1.1, earth=0.6, energy=1.1, ice=0.35, holy=1.1, death=0.2, physical=1.05, drown=1)
...
rift_scythe.walkAround(energy=0, fire=0, poison=0)
