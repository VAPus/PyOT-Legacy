...
grim_reaper.setDefense(50, armor=50, fire=1.1, earth=0.6, energy=1.1, ice=0.35, holy=1.1, death=0.2, physical=0.8, drown=1)
grim_reaper.setExperience(5500)
grim_reaper.setSpeed(400)
grim_reaper.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
