...
tomb_servant.setDefense(10, armor=15, fire=1.1, earth=1, energy=1, ice=1, holy=1.25, death=0, physical=1, drown=1)
tomb_servant.setExperience(215)
tomb_servant.setSpeed(195)
tomb_servant.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
