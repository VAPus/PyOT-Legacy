...
vampire.setDefense(23, armor=40, fire=1.1, earth=0, energy=1, ice=1, holy=1.25, death=0, physical=0.8, drown=0)
vampire.setExperience(305)
vampire.setSpeed(220)
vampire.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=1, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=10)#runs on some low number maybe as low as 1
