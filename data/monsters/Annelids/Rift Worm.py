...
Rift_Worm.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
Rift_Worm.setImmunity(1,1,1) # paralyze, invisible, lifedrain
Rift_Worm.setDefense(30, fire=1.05, earth=0.7, energy=0.9, ice=1.05, holy=1.05, death=0.95, physical=1.05, drown=1.0)