...
Carrion_Worm.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=380, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
Carrion_Worm.setImmunity(0,0,0) # paralyze, invisible, lifedrain
Carrion_Worm.setDefense(10, fire=1.05, earth=0.8, energy=0.9, ice=1.05, holy=1.0, death=1.0, physical=1.0, drown=1.0)