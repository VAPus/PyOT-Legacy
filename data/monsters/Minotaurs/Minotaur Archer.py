...
minotaur_archer.setDefense(armor=9, fire=0.8, earth=1, energy=1, ice=1.1, holy=0.9, death=1.05, physical=1, drown=1)
...
minotaur_archer.loot( ("meat", 4.75), ("piercing bolt", 27.25, 4), ("piece of archer armor", 7.25), (2148, 100, 29), ("broken crossbow", 14.5), ("bolt", 100, 20), ("minotaur leather", 1.25, 3), ("minotaur horn", 1.75, 2), ("brass armor", 0.25), ("crossbow", 0.75), ("scale armor", 0.25) )