...
minotaur_guard.setDefense(armor=19, fire=0.8, earth=1, energy=1, ice=1.1, holy=0.9, death=1.1, physical=1, drown=1)
...
minotaur_guard.loot( (2148, 100, 20), ("minotaur horn", 11.0, 2), ("chain armor", 2.5), ("brass armor", 3.75), ("battle shield", 2.0), ("minotaur leather", 1.0, 3), ("double axe", 0.25), ("health potion", 0.25), ("fishing rod", 0.75), ("minotaur trophy", 0.25) )