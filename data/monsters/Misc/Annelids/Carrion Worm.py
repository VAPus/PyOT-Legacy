Carrion_Worm = genMonster("Carrion Worm", (192, 6069), "a Carrion Worm")
...
Carrion_Worm.behavior(summonable=0, hostile=1, illusionable=0, convinceable=380, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
