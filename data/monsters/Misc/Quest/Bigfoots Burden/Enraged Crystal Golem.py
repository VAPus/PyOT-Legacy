enraged_crystal_golem = genMonster("Enraged Crystal Golem", (508, 18466), "an enraged crystal golem")  #mostly unkniown including blood
...
enraged_crystal_golem.behavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
