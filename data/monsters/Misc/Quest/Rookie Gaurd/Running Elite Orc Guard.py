...
running_elite_orc_guard.behavior(summonable=0, hostile=0, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=1)
