rift_scythe = game.monster.genMonster(_("Rift Scythe"), (300, 6070), _("a rift scythe"))#no corpse
...
rift_scythe.setBehavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
