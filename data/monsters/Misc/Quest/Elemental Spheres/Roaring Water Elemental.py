roaring_water_elemental = game.monster.genMonster(_("Roaring Water Elemental"), (11, 8965), _("a roaring water elemental"))
...
roaring_water_elemental.setImmunity(paralyze=1, invisible=1, lifedrain=1, drunk=1)
