...
overcharged_energy_element.bloodType("undead")
...
overcharged_energy_element.loot( (3031, 100, 175), ("energy soil", 16.5), ("ring of healing", 0.75), ("great health potion", 9.0), ("berserk potion", 0.75), ("small amethyst", 7.25, 2), ("wand of starstorm", 0.25) )