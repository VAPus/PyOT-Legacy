Terror_Bird = genMonster("Terror Bird", (218, 6057), "a terror bird")
...
Terror_Bird.loot( (3031, 100, 30), ("meat", 48.75, 3), ("terrorbird beak", 11.5), ("colourful feather", 3.0), (3976, 9.0), ("health potion", 1.25), ("seeds", 0.25) )
