...
Parrot.behavior(summonable=250, hostile=0, illusionable=1, convinceable=250, pushable=0, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=25)
...
Parrot.regMelee(5)#summons only? probably incorrect information