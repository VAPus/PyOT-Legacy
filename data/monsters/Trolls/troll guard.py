...
troll_guard.setBehavior(summonable=340, attackable=1, hostile=1, illusionable=1, convinceable=340, pushable=1, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=20)
