...
troll_champion.loot( ("arrow", 11.25, 5), ("spear", 22.5), ("leather boots", 13.5), (2148, 100, 12), ("studded club", 3.75), ("meat", 11.25), ("wooden shield", 4.25), ("bunch of troll hair", 3.75), ("silver amulet", 0.5), ("trollroot", 0.5) )