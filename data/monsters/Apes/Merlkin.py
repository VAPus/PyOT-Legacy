...
Merlkin.regMelee(30)
Merlkin.loot( (2148, 100, 44), ("banana staff", 0.25), ("banana", 47.0, 11), ("wand of decay", 1.0), (2162, 3.0), ("banana sash", 2.0), ("orange", 2.5, 5), ("mana potion", 0.75), ("small amethyst", 0.25), ("ape fur", 0.75, 3) )