...
Sibang.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=0, pushCreatures=0, targetDistance=4, runOnHealth=0)
Sibang.voices("Eeeeek! Eeeeek!", "Huh! Huh! Huh!", "Ahhuuaaa!")
Sibang.setImmunity(0,1,0) # paralyze, invisible, lifedrain
Sibang.setDefense(15, fire=0.75, earth=1.0, energy=1.0, ice=1.15, holy=0.9, death=1.05, physical=1.0, drown=1.0)