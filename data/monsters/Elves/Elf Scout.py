...
elf_scout.setDefense(armor=8, fire=1, earth=1, energy=1, ice=1, holy=1, death=1.1, physical=1, drown=1)
...
elf_scout.loot( ('poison arrow', 35.0, 4), ('elven scouting glass', 9.75), ('elvish talisman', 4.75), ('arrow', 100, 12), (2148, 100, 25), ('grapes', 17.25), ('bow', 4.5), ('waterskin', 1.25), ('sandals', 1.0), (5921, 1.0), ('elvish bow', 0.0025) )