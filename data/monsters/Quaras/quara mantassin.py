...
quara_mantassin.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=480, pushable=0, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=40)
