...
quara_predator.loot( ("assassin star", 0.5), (2148, 100, 148), ("double axe", 3.25), ("royal spear", 37.5, 7), ("relic sword", 0.5), ("quara bone", 10.25), ("great health potion", 1.0), ("fish fin", 2.0, 3), ("shrimp", 5.0), ("skull helmet", 0.5), ("small diamond", 7.0, 2), ("glacier robe", 0.5), ("giant shrimp", 0.0025) )