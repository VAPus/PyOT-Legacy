...
Nomad.regMelee(80)
Nomad.loot( (2148, 100, 39), ("axe", 19.5), ("leather legs", 9.25), ("brass shield", 10.75), ("mace", 7.75), ("brass armor", 2.25), ("chain helmet", 3.0), ("steel shield", 0.75), (8838, 8.25, 3), ("iron helmet", 0.75), ("parchment", 0.25), ("rope belt", 2.5), (12412, 0.75) )