...
Crazed_Beggar.setBehavior(summonable=300, attackable=1, hostile=1, illusionable=0, convinceable=300, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
...
Crazed_Beggar.setDefense(5, fire=1.0, earth=1.1, energy=0.8, ice=1.0, holy=0.9, death=1.1, physical=0.9, drown=1.0)