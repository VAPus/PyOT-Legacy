...
Gladiator.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=470, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=18)
