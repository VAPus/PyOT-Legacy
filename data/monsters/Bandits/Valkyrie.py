...
Valkyrie.setBehavior(summonable=450, attackable=1, hostile=1, illusionable=450, convinceable=450, pushable=0, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=10)
...
Valkyrie.setDefense(15, fire=0.9, earth=1.0, energy=1.0, ice=0.9, holy=0.95, death=1.05, physical=1.1, drown=1.0)