...
Dark_Monk.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=480, convinceable=480, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
...
Dark_Monk.setDefense(20, fire=1.0, earth=1.0, energy=1.0, ice=1.0, holy=0.9, death=0.6, physical=1.05, drown=1.0)