...
Bandit.setBehavior(summonable=450, attackable=1, hostile=1, illusionable=1, convinceable=450, pushable=1, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=25)
