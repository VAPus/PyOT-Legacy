...
Amazon.setBehavior(summonable=390, attackable=1, hostile=1, illusionable=390, convinceable=390, pushable=1, pushItems=1, pushCreatures=0, targetDistance=4, runOnHealth=10)
...
Amazon.setDefense(10, fire=1.0, earth=1.0, energy=1.0, ice=1.0, holy=1.0, death=1.05, physical=1.05, drown=1.0)