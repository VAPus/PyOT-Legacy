...
Monk.setBehavior(summonable=600, attackable=1, hostile=1, illusionable=600, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
...
Monk.setDefense(25, fire=1.0, earth=1.0, energy=1.0, ice=1.0, holy=0.5, death=0.5, physical=1.05, drown=1.0)