...
Gang_Member.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=450, convinceable=450, pushable=1, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=35)
...
Gang_Member.setDefense(10, fire=1.0, earth=1.0, energy=1.0, ice=1.0, holy=1.0, death=1.05, physical=1.0, drown=1.0)