...
Gang_Member.setBehavior(summonable=0, hostile=1, illusionable=450, convinceable=450, pushable=1, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=35)
