...
Hero.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
...
Hero.setDefense(40, fire=0.7, earth=0.5, energy=0.6, ice=0.9, holy=0.5, death=1.2, physical=0.9, drown=1.0)