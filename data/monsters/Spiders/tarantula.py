...
tarantula.setBehavior(summonable=485, attackable=1, hostile=1, illusionable=1, convinceable=485, pushable=0, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=0)
