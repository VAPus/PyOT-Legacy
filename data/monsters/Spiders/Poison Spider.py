...
poison_spider.setDefense(armor=4, fire=1.1, earth=0, energy=1, ice=1, holy=1, death=1, physical=1, drown=1)
poison_spider.setExperience(22)
poison_spider.setSpeed(160)#incorrect speed
poison_spider.setBehavior(summonable=270, hostile=1, illusionable=1, convinceable=270, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=6)
