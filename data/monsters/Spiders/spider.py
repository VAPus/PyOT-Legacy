...
spider.setSpeed(152)
spider.setBehavior(summonable=210, attackable=1, hostile=1, illusionable=1, convinceable=210, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=6)
