...
crystal_spider.loot( ("shard", 0.75), ("steel helmet", 5.0), ("plate armor", 9.75), ("ice cube", 5.5), ("sniper arrow", 20.5, 6), (2148, 100, 94), ("brass legs", 8.25), ("crystal sword", 0.75), ("time ring", 0.5), (5879, 1.75), ("knight armor", 0.25), ("strong mana potion", 0.5), ("knight legs", 0.25), ("sapphire hammer", 0.0025), ("platinum amulet", 0.25), ("glacier mask", 0.25), ("jewelled backpack", 0.0025) )