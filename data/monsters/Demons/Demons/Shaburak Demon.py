...
shaburak_demon.bloodType("blood")
...
shaburak_demon.loot( (3031, 100, 252), ("wand of inferno", 0.5), ("small ruby", 15.0, 5), ("strong mana potion", 5.25), ("royal spear", 37.0, 6), ("energy ring", 1.25), ("strong health potion", 6.25), ("piggy bank", 1.0), ("brown mushroom", 3.25), ("bullseye potion", 0.25), ("magma legs", 0.0025), ("magic sulphur", 0.0025) )