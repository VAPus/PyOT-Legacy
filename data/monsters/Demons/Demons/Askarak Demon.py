...
askarak_demon.loot( ("springsprout rod", 0.5), ("mastermind potion", 0.5), ("energy ring", 1.0), ("piggy bank", 0.75), ("small emerald", 9.75, 4), ("strong health potion", 5.25), ("strong mana potion", 4.25), ("assassin star", 18.0, 5), ("brown mushroom", 4.0), (3031, 100, 213), ("terra legs", 0.0025) )