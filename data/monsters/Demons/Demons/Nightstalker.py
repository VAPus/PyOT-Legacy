...
nightstalker.defense(armor=44, fire=1, earth=1, energy=1.05, ice=0.8, holy=0.8, death=1.05, physical=1.05, drown=1)
nightstalker.experience(500)
nightstalker.speed(260)
nightstalker.behavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
nightstalker.walkAround(energy=1, fire=1, poison=1)
nightstalker.immunity(paralyze=1, invisible=1, lifedrain=1, drunk=1)
