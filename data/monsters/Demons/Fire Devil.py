...
fire_devil.setDefense(armor=5, fire=0, earth=0.8, energy=0.7, ice=1.2, holy=1.1, death=0.8, physical=0.9, drown=1)
...
fire_devil.loot( ('guardian shield', 0.75), ('small pitchfork', 21.0), ('blank rune', 10.5), ('double axe', 1.75), ('torch', 2.0, 2), ('cleaver', 1.0), ('scimitar', 4.75), ('necrotic rod', 0.5), ('small amethyst', 0.25) )