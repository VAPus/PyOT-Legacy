coral_frog = game.monster.genMonster(_("Coral Frog"), (226, 6079), _("a coral frog"))
...
coral_frog.setBehavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
