quara_constrictor_scout = game.monster.genMonster(_("Quara Constrictor Scout"), (46, 6065), _("a quara constrictor scout"))
...
qcslifedrain_berserk = spell.Spell("qcslifedrain berserk")
