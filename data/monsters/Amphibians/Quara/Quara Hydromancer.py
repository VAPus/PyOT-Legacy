...
quara_hydromancer.loot( (3031, 100, 90), ("white pearl", 1.75), ("black pearl", 2.0), ("small emerald", 1.5, 2), ("quara eye", 10.25), ("shrimp", 5.0), ("knight armor", 0.25), ("fish fin", 1.0, 3), ("wand of cosmic energy", 1.0), ("ring of healing", 0.5), ("great mana potion", 1.0) )
