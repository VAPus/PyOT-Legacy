...
marid.regMelee(90)
marid.loot( (3031, 100, 128), ("blueberry", 100, 25), (12426, 8.0), ("small sapphire", 6.75), ("hailstorm rod", 1.0), ("strong mana potion", 10.0), ("royal spear", 35.75, 3), ("seeds", 2.5), ("blue tapestry", 2.5), ("heavy machete", 4.5), ("blue piece of cloth", 3.0, 3), ("magma monocle", 0.75), ("wooden flute", 0.25), (12442, 0.5), ("blue gem", 0.25), ("mystic turban", 0.25), ("small oil lamp", 0.0025) )