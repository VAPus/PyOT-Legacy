undead_cavebear = genMonster("Undead Cavebear", (384, 5995), "an undead cavebear")#unknown corpse
...
undead_cavebear.behavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
