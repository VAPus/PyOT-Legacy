...
mutated_rat.behavior(summonable=0, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
...
mutated_rat.regMelee(155, condition=CountdownCondition(CONDITION_POISON, 5), conditionChance=100)
