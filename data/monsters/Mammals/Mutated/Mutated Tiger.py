...
mutated_tiger.loot( (3031, 100, 105), ("meat", 30.75), ("striped fur", 10.75), ("life ring", 5.5), ("silky tapestry", 1.25), ("glorious axe", 1.0), ("sabretooth", 3.25), ("angelic axe", 0.5), ("guardian shield", 0.5), ("strong health potion", 1.25) )