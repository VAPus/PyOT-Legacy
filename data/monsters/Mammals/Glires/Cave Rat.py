cave_rat = genMonster("Cave Rat", (56, 5964), "a cave rat")
cave_rat.type("blood")
cave_rat.health(30)
...
cave_rat.behavior(summonable=250, hostile=1, illusionable=1, convinceable=250, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=3)
