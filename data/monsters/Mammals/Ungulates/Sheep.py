Sheep = game.monster.genMonster(_("Sheep"), (14, 5991), _("a sheep"))
...
Sheep.setBehavior(summonable=250, hostile=0, illusionable=1, convinceable=250, pushable=1, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=20)
Sheep.voices("Maeh")
