Stampor = genMonster("Stampor", (381, 13246), "a stampor")
...
Stampor.loot( ("spiked squelcher", 0.25), ("knight armor", 1.0), ("war hammer", 1.0), ("hollow stampor hoof", 2.75), ("stampor horn", 5.25), ("strong health potion", 7.0, 2), ("platinum coin", 15.0, 2), ("strong mana potion", 7.5, 2), ("small topaz", 12.0, 2), ("stampor talons", 10.75), (3031, 100, 244) ) # , ('stampor talon', 11), ('stampor horn', 5.5), ('hollow stampor hoof', 3.5)
