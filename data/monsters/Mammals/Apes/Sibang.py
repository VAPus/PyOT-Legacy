Sibang = genMonster("Sibang", (118, 6045), "a Sibang")
...
Sibang.behavior(summonable=0, hostile=1, illusionable=1, convinceable=0, pushable=0, pushItems=0, pushCreatures=0, targetDistance=4, runOnHealth=0)
...
Sibang.regMelee(40)
Sibang.regDistance(55, ANIMATION_SMALLSTONE, chance(21))
