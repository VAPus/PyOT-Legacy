Kongra = genMonster("Kongra", (116, 6043), "a Kongra")
...
Kongra.regMelee(60)
Kongra.loot( ("protection amulet", 0.75), (3031, 100, 40), ("banana", 51.75, 12), ("plate armor", 1.0), ("ape fur", 1.0, 3), (12427, 5.25), ("health potion", 0.5), ("power ring", 0.25), ("club ring", 0.25) )