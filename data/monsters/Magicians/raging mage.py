...
raging_mage.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=800)
raging_mage.walkAround(energy=0, fire=0, poison=0)
raging_mage.setImmunity(paralyze=1, invisible=1, lifedrain=1, drunk=1)
#raging_mage.voices(*argc)