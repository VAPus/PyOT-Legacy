...
necromancer.setDefense(armor=22, fire=1.05, earth=0, energy=0.8, ice=0.9, holy=1.05, death=0.5, physical=1.05, drown=1)
...
necromancer.loot( ("book of necromantic rituals", 9.5), ("mystic turban", 0.5), ("poison arrow", 43.75, 5), ("green mushroom", 1.5), (2148, 100, 90), ("necromantic robe", 1.0), ("boots of haste", 0.25), ("strong mana potion", 0.5), ("skull staff", 0.0025), ("clerical mace", 0.5), ("spellbook of warding", 0.0025), ("noble axe", 0.0025) )