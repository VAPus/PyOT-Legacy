...
ice_witch.setDefense(armor=21, fire=0.5, earth=1, energy=1, ice=0, holy=1, death=1, physical=1, drown=1)
...
ice_witch.loot( (2148, 100, 90), ("ice cube", 10.0), ("shard", 0.75), ("strong mana potion", 0.75), ("green mushroom", 1.75), ("clerical mace", 1.0), ("mystic turban", 0.25), ("diamond sceptre", 0.5), ("crystal sword", 0.25), (7459, 0.0025) )