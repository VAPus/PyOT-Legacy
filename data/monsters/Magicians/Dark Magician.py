...
dark_magician.setDefense(armor=18, fire=0.9, earth=0.8, energy=0.8, ice=0.9, holy=0.8, death=1.05, physical=1, drown=1)
...
dark_magician.loot( (2148, 100, 55), ("strong mana potion", 3.75), ("blank rune", 9.0), ("mana potion", 12.25), (7762, 0.75), ("health potion", 12.25), ("strong health potion", 2.75), ("necrotic rod", 0.25), ("reins", 0.0025) )