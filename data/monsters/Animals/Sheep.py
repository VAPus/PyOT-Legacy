...
Sheep.setBehavior(summonable=250, attackable=1, hostile=0, illusionable=250, convinceable=250, pushable=1, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=20)
Sheep.voices("Maeh")
