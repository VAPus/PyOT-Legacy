...
Skunk.setBehavior(summonable=200, attackable=1, hostile=1, illusionable=1, convinceable=200, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=2)
