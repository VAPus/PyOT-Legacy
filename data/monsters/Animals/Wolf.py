...
Wolf.setBehavior(summonable=255, attackable=1, hostile=1, illusionable=1, convinceable=255, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=8)
