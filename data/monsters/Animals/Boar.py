...
boar.setBehavior(summonable=465, attackable=1, hostile=1, illusionable=465, convinceable=465, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=20)
...
boar.loot( ('haunch of boar', 15.25, 2 ), ('gold coin', 12.825, 20) )
