...
Polar_Bear.setBehavior(summonable=315, attackable=1, hostile=1, illusionable=1, convinceable=315, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=5)
