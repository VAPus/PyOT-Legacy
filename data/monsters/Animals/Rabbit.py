...
Rabbit.setBehavior(summonable=220, attackable=1, hostile=0, illusionable=1, convinceable=220, pushable=1, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=15)
...
Rabbit.loot( ('carrot', 10), ('meat', 43.5, 2) )