...
cave_rat.setBehavior(summonable=250, attackable=1, hostile=1, illusionable=1, convinceable=250, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=3)
...
cave_rat.loot( ('cookie', 1.5 ), ('cheese', 30), ('worm', 12, 3), ('gold coin', 63, 2) )