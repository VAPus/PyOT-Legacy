...
Silver_Rabbit.setBehavior(summonable=220, attackable=1, hostile=0, illusionable=220, convinceable=220, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=15)
Silver_Rabbit.setImmunity(0,0,0) # paralyze, invisible, lifedrain
Silver_Rabbit.setDefense(3, fire=1.0, earth=1.0, energy=1.0, ice=1.0, holy=1.0, death=1.0, physical=1.0, drown=1.0)
