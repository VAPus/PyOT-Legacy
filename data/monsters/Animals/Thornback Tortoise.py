...
Thornback_Tortoise.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=1, convinceable=490, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
...
Thornback_Tortoise.loot( ('fish', 10.25), ('white mushroom', 2), ('ham', 0.5), ('gold coin', 27.25, 30), ('thorn', 6), ('tortoise egg', 2.65, 3), ('health potion', 1.25), ('war hammer', 1), ('brown mushroom', 1.5) )