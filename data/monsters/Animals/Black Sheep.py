...
black_sheep.setBehavior(summonable=250, attackable=1, hostile=0, illusionable=250, convinceable=250, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=20)
black_sheep.voices("Maeh")
black_sheep.setImmunity(0,0,0) # paralyze, invisible, lifedrain
black_sheep.setDefense(3, fire=1.1, earth=1.0, energy=1.0, ice=1.0, holy=1.0, death=1.0, physical=1.0, drown=1.0)
black_sheep.loot( ('meat', 13.75, 5), ('black wool', 1.25 )