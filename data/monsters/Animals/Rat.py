...
Rat.setBehavior(summonable=220, attackable=1, hostile=1, illusionable=220, convinceable=220, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=5)
Rat.voices("Meep!")
