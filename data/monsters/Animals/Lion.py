...
Lion.setBehavior(summonable=320, attackable=1, hostile=1, illusionable=1, convinceable=320, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=10)
Lion.voices("Groarrr!")
