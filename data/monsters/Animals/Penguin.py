...
Penguin.setBehavior(summonable=290, attackable=1, hostile=1, illusionable=1, convinceable=290, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=32)
