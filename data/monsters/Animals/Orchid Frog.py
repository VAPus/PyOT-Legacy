...
Orchid_Frog.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
Orchid_Frog.voices("Ribbit!", "Ribbit! Ribbit!")
Orchid_Frog.setImmunity(0,0,0) # paralyze, invisible, lifedrain
Orchid_Frog.setDefense(10, fire=1.1, earth=1.0, energy=1.0, ice=0.85, holy=1.0, death=1.0, physical=1.0, drown=1.0)
