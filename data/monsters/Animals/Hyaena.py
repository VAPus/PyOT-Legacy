...
Hyaena.setBehavior(summonable=275, attackable=1, hostile=1, illusionable=1, convinceable=275, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=30)
