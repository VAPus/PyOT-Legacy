...
Panda.setBehavior(summonable=300, attackable=1, hostile=1, illusionable=1, convinceable=300, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=10)
