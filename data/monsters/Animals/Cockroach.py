...
cockroach.setBehavior(summonable=200, attackable=1, hostile=0, illusionable=1, convinceable=200, pushable=1, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=1)
...
cockroach.loot( ('cockroach leg', 100) )