...
Pig.setBehavior(summonable=255, attackable=1, hostile=0, illusionable=1, convinceable=255, pushable=1, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=25)
...
Pig.loot( ('meat', 16.5, 4), ('pig foot', 1.5) )