...
Parrot.setBehavior(summonable=250, attackable=1, hostile=0, illusionable=250, convinceable=250, pushable=0, pushItems=0, pushCreatures=0, targetDistance=0, runOnHealth=25)
...
Parrot.setDefense(3, fire=1.0, earth=1.0, energy=1.0, ice=1.0, holy=1.0, death=1.0, physical=1.0, drown=1.0)
