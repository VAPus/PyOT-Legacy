...
Toad.setBehavior(summonable=400, attackable=1, hostile=1, illusionable=1, convinceable=400, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=10)
