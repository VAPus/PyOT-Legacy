...
crimson_frog.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
crimson_frog.voices("Ribbit!", "Ribbit! Ribbit!")
crimson_frog.setImmunity(0,0,0) # paralyze, invisible, lifedrain
crimson_frog.setDefense(10, fire=1.1, earth=1.0, energy=1.0, ice=0.85, holy=1.0, death=1.0, physical=1.0, drown=1.0)
crimson_frog.loot( ('worm', 9), ('gold coin', 30.5, 10 ) )
