...
scorpion.setDefense(armor=7, fire=1.1, earth=0, energy=0.8, ice=1.1, holy=1, death=1, physical=1, drown=1)
scorpion.setExperience(45)
scorpion.setSpeed(150)
scorpion.setBehavior(summonable=310, hostile=1, illusionable=1, convinceable=310, pushable=1, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=5)
