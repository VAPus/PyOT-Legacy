...
son_of_verminor.setDefense(armor=30, fire=0.9, earth=0, energy=0.8, ice=1, holy=1, death=1, physical=1, drown=1)
son_of_verminor.setExperience(5900)
son_of_verminor.setSpeed(120)#incorrect?
son_of_verminor.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=0, pushable=0, pushItems=1, pushCreatures=0, targetDistance=1, runOnHealth=0)
