...
orc_leader.setBehavior(summonable=640, attackable=1, hostile=1, illusionable=1, convinceable=640, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
