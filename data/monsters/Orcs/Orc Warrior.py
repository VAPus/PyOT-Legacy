...
orc_warrior.setDefense(armor=11, fire=1, earth=1.1, energy=0.7, ice=1, holy=0.9, death=1.1, physical=1, drown=1)
...
orc_warrior.loot( (2148, 100, 15), ("meat", 15.75), ("chain armor", 7.25), ("skull belt", 1.25), ("orc tooth", 0.75), ("orc leather", 4.0), ("broken helmet", 10.0), ("copper shield", 0.5), ("orc tusk", 0.0025), ("poison dagger", 0.0025) )