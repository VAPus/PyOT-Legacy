...
orc_marauder.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=490, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
