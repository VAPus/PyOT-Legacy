...
orc_rider.setDefense(armor=17, fire=1, earth=1.1, energy=0.8, ice=1, holy=0.9, death=1.1, physical=1, drown=1)
...
orc_rider.loot( ("orcish axe", 6.75), ("warwolf fur", 10.75), ("meat", 26.0, 3), (2148, 100, 74), ("orc leather", 8.75), ("scale armor", 1.0), ("torch", 1.75), ("wolf tooth chain", 9.25), ("orc tooth", 2.5), ("battle shield", 1.0), ("obsidian lance", 0.75) )