...
lizard_gate_guardian.setExperience(experience)
lizard_gate_guardian.setSpeed(speed)
...
lizard_gate_guardian.voices(*arg)
lizard_gate_guardian.regMelee(1)
lizard_gate_guardian.loot()