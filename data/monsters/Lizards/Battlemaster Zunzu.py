...
Battlemaster_Zunzu.loot( (2148, 100, 166), ("red lantern", 100.0), ("zaoan shoes", 3.25), ("small emerald", 61.25, 10), ("zaogun flag", 11.25), ("strong health potion", 3.0), ("lizard scale", 0.75, 3), ("great health potion", 0.75), ("zaoan legs", 2.5), ("lizard leather", 1.75), ("zaoan armor", 1.0) )