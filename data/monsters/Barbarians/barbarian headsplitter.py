...
Barbarian_Headsplitter.setBehavior(summonable=0, attackable=1, hostile=1, illusionable=0, convinceable=450, pushable=0, pushItems=0, pushCreatures=0, targetDistance=1, runOnHealth=0)
