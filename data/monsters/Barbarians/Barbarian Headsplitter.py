...
Barbarian_Headsplitter.loot( (2148, 100, 30), ("torch", 60.75), ("brass helmet", 20.25), ("scale armor", 4.25), ("viking helmet", 4.75), ("knife", 15.0), ("health potion", 0.5), ("life ring", 0.25), ("skull", 3.25), ("krimhorn helmet", 0.0025), ("brown piece of cloth", 1.0, 3), ("fur boots", 0.0025) )