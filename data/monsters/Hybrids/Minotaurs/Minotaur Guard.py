...
minotaur_guard.behavior(summonable=550, hostile=1, illusionable=1, convinceable=550, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=0)
