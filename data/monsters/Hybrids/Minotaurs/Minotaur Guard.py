...
minotaur_guard.loot( (3031, 100, 20), ("minotaur horn", 10.25, 2), ("chain armor", 2.75), ("brass armor", 3.75), ("piece of warrior armor", 5.5), ("battle shield", 2.0), ("minotaur leather", 1.0, 3), ("double axe", 0.5), ("health potion", 0.25), ("fishing rod", 0.75), ("minotaur trophy", 0.25) )