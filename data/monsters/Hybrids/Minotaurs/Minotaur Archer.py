...
minotaur_archer.behavior(summonable=390, hostile=1, illusionable=1, convinceable=390, pushable=1, pushItems=0, pushCreatures=1, targetDistance=4, runOnHealth=10)
