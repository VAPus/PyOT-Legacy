...
dworc_venomsniper.bloodType("blood")
...
dworc_venomsniper.loot( (3031, 100, 13), ("leather armor", 9.5), ("throwing knife", 13.0, 2), ("poison arrow", 9.25, 3), ("skull", 1.5, 2), ("tribal mask", 0.5), ("torch", 5.25), ("poison dagger", 1.75), ("bast skirt", 0.0025), ("seeds", 0.25), ("bronze amulet", 0.0025) )