...
pirate_corsair.setDefense(armor=27, fire=1.1, earth=0.8, energy=1, ice=0.95, holy=0.9, death=1.05, physical=1, drown=1)
...
pirate_corsair.loot( ("throwing star", 52.5, 12), ("rum flask", 0.0025), (2148, 100, 88), ("sabre", 9.75), ("compass", 10.0), ("dark shield", 1.25), ("peg leg", 0.5), ("pirate boots", 0.25), ("hook", 0.5, 3), ("dark armor", 1.75), ("pirate backpack", 1.0), ("strong health potion", 0.75), ("eye patch", 0.5), ("pirate hat", 0.75), ("skull candle", 0.25), ("piggy bank", 0.25) )