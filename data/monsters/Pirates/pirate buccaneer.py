...
pirate_buccaneer.setBehavior(summonable=0, attackable=1, hostile=2, illusionable=1, convinceable=595, pushable=0, pushItems=1, pushCreatures=1, targetDistance=1, runOnHealth=20, targetChange=0))
