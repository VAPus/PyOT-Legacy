hen = game.npc.genNPC("Hen", (130, 39, 122, 125, 37, 2212), "AltSystemTest the test char")
hen.setWalkable(False)
...
hen.speakTree({(lambda player, **k: player not in playersWhoGotFreeIcecream, "Hello, what do you want?", "Why are you back, I already gave you icecream! Ow well, what do you want this time?"):
    {"icecream":
        {"What flavour?":
