...
def stepIn(creature, item, position):
...
def stepOut(creature, item, position):
    if creature.player():
...
game.scriptsystem.get("walkOn").reg(4620, stepIn, toid=4625)
game.scriptsystem.get("walkOff").reg(4620, stepOut, toid=4625)