...
spell.selfTargetSpell("exura", 1, 9, 20, spell.HEALING_GROUP, enum.EFFECT_MAGIC_BLUE, spell.healTarget(1.4, 1.795, 8, 11)) # words, icon, level, mana, group, effect, callback, cooldown=1